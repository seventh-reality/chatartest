...
if ( ! class_exists( 'Sth_googlemap' ) ) {
	...
	class Sth_googlemap {
		...
		public static function output( $atts, $content = null ) {
			...
			$zoom_level = isset($atts['zoom_level'])?$atts['zoom_level']:'';
			$map_title = isset($atts['map_title'])?$atts['map_title']:'';	
			$map_marker_id = isset($atts['map_marker'])?$atts['map_marker']:'';
			$map_marker = wp_get_attachment_image_src($map_marker_id,'full');
			$map_style = isset($atts['map_style'])?$atts['map_style']:'';

			$fullscreen = isset($atts['fit_to_screen'])?$atts['fit_to_screen']:'fullscreen';

			$map_desc = isset($atts['map_desc'])?$atts['map_desc']:'';
			$map_background = isset($atts['map_background'])?$atts['map_background']:'';
			$map_background_color = isset($atts['map_background_color'])?$atts['map_background_color']:'';

...
/**
 * Title: Header Image
 * Slug: camera-rental/header-image
 * Categories: camera-rental, header-image
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.png'); ?>","id":15,"dimRatio":50,"minHeight":400} -->

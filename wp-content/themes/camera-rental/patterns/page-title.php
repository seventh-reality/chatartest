...
/**
 * Title: Page Title
 * Slug: camera-rental/page-title
 * Categories: camera-rental, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.png'); ?>","id":6,"dimRatio":50,"minHeight":400,"className":"inner-cover-img","layout":{"type":"constrained","contentSize":"90%"}} -->

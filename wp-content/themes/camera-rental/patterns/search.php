...
/**
 * Title: Search
 * Slug: camera-rental/search
 * Categories: camera-rental, search
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.png'); ?>","id":6,"dimRatio":50,"isUserOverlayColor":true,"minHeight":400,"align":"full","className":"inner-cover-img","layout":{"type":"constrained","contentSize":"90%"}} -->

 ...
 * Slug: camera-rental/search-product
 * Categories: camera-rental, search-product
 */
?>
...
<!-- wp:paragraph -->
<p><?php esc_html_e('No products were found matching your selection.','camera-rental'); ?></p>
<!-- /wp:paragraph -->
